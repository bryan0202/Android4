...
class MiagendaApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(debugShowCheckedModeBanner: false, title: "galeria fotografica", home: new PaginaPrincipal(title: "Mi Galeria Bryan")); //fin de materialapp return
